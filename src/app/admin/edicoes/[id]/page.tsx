        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Link
              ...
              className="rounded-2xl bg-white p-4 ring-1 ring-zinc-200 hover:ring-zinc-700"
            >
              <h3 className="text-base font-semibold">Cartelas</h3>
              <p className="mt-1 text-sm text-zinc-600">Cadastrar/Importar cartelas (20 números)</p>
            </Link>
            ...
            >
              ...
              <p className="mt-1 text-sm text-zinc-600">Marcar números (1–50) e apurar ganhadores</p>
            </Link>
          </div>

          <Link
            href="/admin/edicoes"
            className="inline-flex text-sm text-zinc-700 underline decoration-zinc-600 hover:text-zinc-100"
          >
            ← Voltar para edições
          </Link>
        </div>
